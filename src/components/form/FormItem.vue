<template>
  ...
  >
    ...
    <template v-if="showLabel" #label>
      <span class="wd-form-item__label">
        <span class="wd-form-item__title">
        ...
        <el-tooltip
          ...
          :show-after="100"
        >
          <span class="wd-form-item__tip" tabindex="0" role="note" aria-label="帮助说明">
            <el-icon>
              <QuestionFilled />
            </el-icon>
          </span>
...
defineOptions({ name: 'WdFormItem', inheritAttrs: false })
...
.wd-form-item__tip:focus-visible {
